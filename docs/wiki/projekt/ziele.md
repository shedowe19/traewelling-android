...
- **Perfekte Synchronisation manueller Edits**: Priorisiert im Backend vorgenommene Zeitkorrekturen (`manualDeparture` / `manualArrival`) und stellt diese konsistent (rot für Verspätung, grün für Pünktlich) in der gesamten App dar.
